  ...
  return (
    <>
      <PageHeader
        ...
        tone="ink"
        photo="погрузка чана в машину на площадке"
  ...
  return (
    <>
      <PageHeader
        ...
        tone="copper"
        photo="сварной шов чаши крупным планом"
  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumb="Вопросы"
        tone="olive"
        photo="чан с паром на участке зимой"
  ...
  return (
    <>
      <PageHeader
        title="Контакты"
        tone="terracotta"
        photo="площадка производства снаружи"
